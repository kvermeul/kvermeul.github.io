...
- HIJ-IX (409KE, CIEDS, starting Fall 2026): Attacks in the IXPs: Opportunities, impacts, and counter-measures with the nxthdr.dev platform.
- CIFRE doctoral project with AFNIC: How do AI agents reshape the Internet? 
- EDMITT doctoral project: Augmenting Internet measurements with metadata for a better Internet cartography.
